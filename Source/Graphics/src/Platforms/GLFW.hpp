...
private:
    ...
    constexpr static Event::KeyCode mapGLFWKey( int glfwKey ) 
    {
        switch ( glfwKey ) 
        {
            ...
            case GLFW_KEY_B: return Event::KeyCode::B;
            case GLFW_KEY_C: return Event::KeyCode::C;
            case GLFW_KEY_D: return Event::KeyCode::D;
            case GLFW_KEY_E: return Event::KeyCode::E;
            case GLFW_KEY_F: return Event::KeyCode::F;
            case GLFW_KEY_G: return Event::KeyCode::G;
            case GLFW_KEY_H: return Event::KeyCode::H;
            case GLFW_KEY_I: return Event::KeyCode::I;
            case GLFW_KEY_J: return Event::KeyCode::J;
            case GLFW_KEY_K: return Event::KeyCode::K;
            case GLFW_KEY_L: return Event::KeyCode::L;
            case GLFW_KEY_M: return Event::KeyCode::M;
            case GLFW_KEY_N: return Event::KeyCode::N;
            case GLFW_KEY_O: return Event::KeyCode::O;
            case GLFW_KEY_P: return Event::KeyCode::P;
            case GLFW_KEY_Q: return Event::KeyCode::Q;
            case GLFW_KEY_R: return Event::KeyCode::R;
            case GLFW_KEY_S: return Event::KeyCode::S;
            case GLFW_KEY_T: return Event::KeyCode::T;
            case GLFW_KEY_U: return Event::KeyCode::U;
            case GLFW_KEY_V: return Event::KeyCode::V;
            case GLFW_KEY_W: return Event::KeyCode::W;
            case GLFW_KEY_X: return Event::KeyCode::X;
            case GLFW_KEY_Y: return Event::KeyCode::Y;
            case GLFW_KEY_Z: return Event::KeyCode::Z;
            ...
            case GLFW_KEY_ENTER:  return Event::KeyCode::Enter;
            case GLFW_KEY_TAB:    return Event::KeyCode::Tab;
            // case GLFW_KEY_BACKSPACE: return Event::KeyCode::Backspace;
            
            case GLFW_KEY_LEFT_SHIFT:  return Event::KeyCode::Shift;
            case GLFW_KEY_RIGHT_SHIFT: return Event::KeyCode::Shift;
            case GLFW_KEY_LEFT_CONTROL: return Event::KeyCode::Control;
            case GLFW_KEY_RIGHT_CONTROL: return Event::KeyCode::Control;
            case GLFW_KEY_LEFT_ALT:    return Event::KeyCode::Alt;
