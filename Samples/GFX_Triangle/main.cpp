 ...
 *
 * Description:
 * Entry point for the Raster demonstration. This sample implements a simple "Hello World" type program 
 * where a triangle is procedurally defined and rasterized onto a window
 * 
 *
...
int main( /*int argc, char* argv[]*/ ) {
    ...
    {
#ifdef AXION_DEBUG
        Axion::Logger::init( Logger::Level::Info, "GFXTriangleSample.log" );
#endif
